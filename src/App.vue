...
const navigationLinks = computed(() => {
  ...
  if (role === USER_ROLES.SUPERADMIN) {
    return [
      ...
      { id: 'sa1', to: '/admin/suscripciones', icon: 'mdi-cash-register', label: 'Solicitudes y Pagos' },
  ...
  if (role !== USER_ROLES.OPERADOR) {
    ...
    links.push({ id: 10, to: '/hacienda/directorio-asesores', icon: 'mdi-account-tie', label: 'Asesores y Marketplace BPA', group: 'Extra' })
